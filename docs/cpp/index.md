...
| Valgrind  | 内存泄漏定位工具                                        | [下载](https://valgrind.org/downloads/)                 |

## 第三方库代码：

| 名称        | 介绍                                  | 链接                                                                         |
| ----------- | ------------------------------------- | ---------------------------------------------------------------------------- |
| argparse    | 命令行解析器                          | [github](https://github.com/p-ranav/argparse)                                |
| [fmt](../c-ref/fmt.md)         | 提供了类似 Python 的字符串插值功能    | [github](https://github.com/fmtlib/fmt)                                      |
| libfort     | 用于在终端输出表格                    | [github](https://github.com/seleznevae/)                                     |
| libpg_query | PostgreSQL 语法的解析器，用于查询解析 | [github](https://github.com/duckdb/duckdb/tree/main/third_party/libpg_query) |
| linenoise   | 用于创建交互式命令行界面              | [linenoise](https://github.com/antirez/linenoise)                            |
| M\*LIB      | 容器类型工具库                        | [github](https://github.com/P-p-H-d/mlib)                                    |
